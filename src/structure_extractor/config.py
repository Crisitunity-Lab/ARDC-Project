...
class Configuration:
    countries = dict({
        ...
        '2013_Glasgow_helicopter_crash':'UK',
        '2013_Brazil_nightclub_fire':'Brazil',
        '2013_Russia_meteor':'Russia',
        '2013_Sardinia_floods':"Italy",
        '2012_Philipinnes_floods':'Philippines',
        '2012_Costa_Rica_earthquake':'Costa Rica',
        '2012_Venezuela_refinery':'Venezuela',
        '2013_Alberta_floods':'Canada',
        '2013_Queensland_floods':'Australia',
        '2013_NY_train_crash':'US',
        '2013_Australia_bushfire':'Australia',
        '2013_LA_airport_shootings':'US',
        '2012_Typhoon_Pablo':'Philippines',
        '2013_Lac_Megantic_train_crash':'Canada',
        '2013_Spain_train_crash':'Spain',
        '2013_West_Texas_explosion':'US',
        '2012_Guatemala_earthquake':'Guatemala',
        '2013_Savar_building_collapse':'Bangladesh',
        '2012_Italy_earthquakes':'Italy',
        '2013_Bohol_earthquake':'Philippines',
        '2013_Singapore_haze':'Singapore',
        '2013_Boston_bombings':'US',
        '2013_Manila_floods':'Philippines',
        '2013_Typhoon_Yolanda':'Philippines'
    })
